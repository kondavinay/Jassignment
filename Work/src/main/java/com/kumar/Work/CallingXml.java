...
import com.kumar.Work.CallingXml;
import com.kumar.Work.ReadXmlFile2;

public class CallingXml extends DefaultHandler implements MethodsFile {
	private ReadXmlFile2 read;
	private String temp;
	private ArrayList<ReadXmlFile2> accList = new ArrayList<ReadXmlFile2>();

	public void display2() throws IOException, SAXException, ParserConfigurationException
